...
function setup() {
  ...
  let total = 50;
  //arm wires
  wires.push(new Wire(100, 100, total, spacing))
  wires.push(new Wire(700, 100, total, spacing))

  //leg wires
  wires.push(new Wire(300, 100, 100, 4))
  wires.push(new Wire(500, 100, 100, 4))
  ...
  let wire3 = wires[2].particles[wires[2].particles.length-1];
  let wire4 = wires[3].particles[wires[3].particles.length-1];

  leftArm = new Limb(wire1.x, wire1.y, 3, 125, 1);
  rightArm = new Limb(wire2.x, wire2.y, 3, 125, -1);
  // leftLeg = new Lim(
  leftLeg = new Limb(wire4.x, wire3.y, 3, 125, -1);
  rightLeg = new Limb(wire3.x, wire4.y, 3, 125, 1);
...
class Limb {
  constructor(x, y, total, spacing, dir){
    this.particles = [];

    for (let i = 0; i < total; i++) {
      //{!1} Spacing them out along the x-axis
      let particle = new Particle(x + i * spacing * dir, y, 16);
