...
function setup() {
  ...
  let randomColor = color(random(255), random(255), random(255), 5);
  ...
  while(ownRadius > width/200 && ownRadius > minSize){
    ownRadius = prevRadius - random(2, minSize);
    ...
    circs.push({color: randomColor, x: cx, y: cy, size: ownRadius * 2});
