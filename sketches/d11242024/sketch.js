...
async function detectFaces(video, canvas) {
  ...
  async function detect() {
    ...
    if(resizedDetections.length > 0){
      ...
      let centerX = firstFace.box.x + firstFace.box.width/2;
      let centerY = firstFace.box.y + firstFace.box.height/2;
      let width = firstFace.box.width * 1.5;
      let height = firstFace.box.height * 2; 
      ctx.fillStyle = "red";
      ctx.fillRect (centerX -  width/2, centerY - height * 0.6, width, height)
    }
