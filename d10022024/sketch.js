...
class Cell {
  ...
  divide() {
    ...
    if(this.size > 10){
      let children = [];
      //this needs to a a loop or recursive or something
      ...
      // children.push(new Cell(this.x + this.size/2 - this.size/6, this.y, this.size/3, randomColor()));
      children.push(new Cell(this.x + this.size/3, this.y, this.size/3, randomColor()));
      children.push(new Cell(this.x + this.size/3, this.y + this.size * (2/3), this.size/3, randomColor()));
      
      children.push(new Cell(this.x + this.size * (1/6), this.y + this.size/12, this.size/6, randomColor()));
      children.push(new Cell(this.x + this.size * (2/3), this.y + this.size/12, this.size/6, randomColor()));

      children.push(new Cell(this.x + this.size * (1/6), this.y + this.size * (3/4), this.size/6, randomColor()));
      children.push(new Cell(this.x + this.size * (2/3), this.y + this.size * (3/4), this.size/6, randomColor()));
