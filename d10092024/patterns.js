...
function topFilter(cornerX, cornerY, count, cellSize){
  ...
  noStroke();
  fill(globalFill);
  triangle(cornerX, cornerY, cornerX + cellSize, cornerY, cornerX + cellSize/2, cornerY + cellSize/2);
...
function bottomFilter(cornerX, cornerY, count, cellSize){
  ...
  noStroke();
  fill(globalFill);
  triangle(cornerX, cornerY + cellSize, cornerX + cellSize, cornerY + cellSize, cornerX + cellSize/2, cornerY + cellSize/2);
...
function leftFilter(cornerX, cornerY, count, cellSize){
  ...
  noStroke();
  fill(globalFill);
  triangle(cornerX, cornerY, cornerX, cornerY + cellSize, cornerX + cellSize/2, cornerY + cellSize/2);
...
function rightFilter(cornerX, cornerY, count, cellSize){
  ...
  noStroke();
  fill(globalFill);
  triangle(cornerX + cellSize, cornerY, cornerX + cellSize, cornerY + cellSize, cornerX + cellSize/2, cornerY + cellSize/2);
...
function diagonalRightBottom(cornerX, cornerY, count, cellSize){
  ...
  noStroke();
  fill(globalFill);
  triangle(cornerX, cornerY + cellSize, cornerX + cellSize, cornerY + cellSize, cornerX + cellSize, cornerY);
...
function diagonalRightTop(cornerX, cornerY, count, cellSize){
  ...
  noStroke();
  fill(globalFill);
  triangle(cornerX, cornerY + cellSize, cornerX, cornerY, cornerX + cellSize, cornerY);
...
function diagonalLeftBottom(cornerX, cornerY, count, cellSize){
  ...
  noStroke();
  fill(globalFill);
  triangle(cornerX, cornerY, cornerX, cornerY + cellSize, cornerX + cellSize, cornerY + cellSize);
...
function diagonalLeftTop(cornerX, cornerY, count, cellSize){
  ...
  noStroke();
  fill(globalFill);
  triangle(cornerX, cornerY, cornerX + cellSize, cornerY, cornerX + cellSize, cornerY + cellSize);
